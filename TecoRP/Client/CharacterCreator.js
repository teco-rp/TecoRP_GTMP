...
function fillHairMenu() {
    ...
    for (let i = 0; i < hairIDList[currentGender].length; i++) hair_list.Add(hairNameList[currentGender][i]);
    ...
    for (let i = 0; i < API.getNumHairColors(); i++) hair_color_list.Add(i.toString());
